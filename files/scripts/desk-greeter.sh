...
# with the Giants "al-Khwarizmi" picture as its background, and make
...
install -m 0644 "$SRC"/desk/.local/share/wallpapers/Giants/18-al-khwarizmi.png "$THEME"/background.png
